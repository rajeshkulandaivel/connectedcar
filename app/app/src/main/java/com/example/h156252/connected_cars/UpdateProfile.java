...
public class UpdateProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Toast.makeText(getApplicationContext(),"Exception in getdetails()  "+e.getLocalizedMessage(),Toast.LENGTH_SHORT).show();
        }
        ...
        btUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                new HttpAsyncTask().execute("http://myfirst.au-syd.mybluemix.net/api/Items/"+number);
                finish();
            }
            });
